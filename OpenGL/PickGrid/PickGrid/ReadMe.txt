================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PickGrid プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PickGrid には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PickGrid アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
PickGrid.h
   ...
   CPickGridApp アプリケーション クラスを宣言します。

PickGrid.cpp
   これは、アプリケーション クラス CPickGridApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PickGrid.ico
   ...
   アイコンはメイン リソース ファイル PickGrid.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、PickGrid.rc ファイル内
...
PickGridDoc.h, PickGridDoc.cpp - ドキュメント
   これらのファイルは CPickGridDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CPickGridDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

PickGridView.h, PickGridView.cpp - ドキュメントのビュー
   これらのファイルは CPickGridView クラスを含みます。
   CPickGridView オブジェクトは CPickGridDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   PickGrid.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
